...
class Gallery extends CI_Controller {
    ...
    public function index(){
        ...
        $get_data ['where']['post_type'] = 2; // Only Gallery Data;
        ...
        $this->load->view('dashboard/gallery/all_gallery',$data);
    } 
    ...
    public function create_gallery() {
        ...
        $data['menu'] = $this->load->view('dashboard/menu','',TRUE);
        $data['footer'] = $this->load->view('dashboard/footer','',TRUE);
        $this->load->view('dashboard/gallery/create_gallery',$data);
    }
    
    public function process_gallery() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (count($_FILES['other_image']['error'][0]) == 0) {
...
//        $config['height']         = $param['img_height'];
    ...
    public function edit_gallery($edit_id) {
        $get_data ['table']         =   "post_data";
        ...
        $this->load->view('dashboard/gallery/edit_gallery',$data);
    }
    ...
    public function process_update_gallery(){
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $post_data = [
                'post_type' => 2, // 1=means Exhibition
                'title' => $this->input->post("title"),
                'descriptions' => $this->input->post("descriptions"),
                'start_date' => $this->input->post("start_date"),
                'end_date' => $this->input->post("end_date"),
