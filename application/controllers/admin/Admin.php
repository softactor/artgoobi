...
class Admin extends CI_Controller {
    ...
    public function get_profile_info_by_id(){
        ...
        $get_data['columns'] = $columns;
        $get_data ['where'] = $where; 
        $table_data = get_all_data_by_joining_table($get_data);        
        echo json_encode($table_data[0]);
    ...
    public function signup_process_update(){        
        ...
        $users_det_data['country_id'] =   $this->input->post('country');       
    ...
    public function artist_artwork_update($update_id) {
        ...
        $redirect_url = base_url()."admin/pending_artwork_details/".$this->input->post('hidden_artist_id');
