                            ...
                            <div class="row">
                                            ...
                                            <select class="form-control" id="type_of_art_id" name="type_of_art_id" onchange="get_subtype_artwork(this.value);">
                                                ...
                                                if (isset($art_type) && !empty($art_type)) {
                                                    foreach ($art_type as $type) {
                                                        ?>
                                                        <option value="<?php echo $type->id; ?>" <?php if(isset($artwork_data->type_of_art_id) && $artwork_data->type_of_art_id == $type->id){ echo 'selected'; } ?>><?php echo $type->name; ?></option>
                                                        <?php
                                                    }
                                                }
                                                ?>
                                ...
                                <div class="col col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">          
                                            <input type="text" class="form-control" id="price" placeholder="price" name="price" value="<?php echo set_value('price',$artwork_data->price); ?>" onkeyup="calculateActualPrice();" autocomplete="off" <?php if($artwork_data->not_for_sale){ echo 'disabled'; } ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">          
                                            <div class="checkbox">
                                                <label><input type="checkbox" name='not_for_sale' id="not_for_sale" value="1" onchange="togglePriceShowhide();"<?php if($artwork_data->not_for_sale){ echo 'checked'; } ?>>Not For Sale</label>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            ?>
                                            <input type="text" class="form-control" id="actual_price" placeholder="Actual price" name="actual_price" value="<?php echo $actual_get_price; ?>"<?php if($artwork_data->not_for_sale){ echo 'disabled'; } ?>>
