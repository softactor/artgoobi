    ...
    <div class="row">
        <div class="col-md-12">
            <div class="jumbotron text-center">
                <h1 class="service_title">Exhibition List</h1>      
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="brdr bgc-fff pad-10 box-shad btm-mrg-20 property-listing">
                            <div class="media">
                                <a class="pull-left" href="<?php echo base_url('welcome/exhibition_details/'.$exhibition->id); ?>">
                                ...
                                <div class="media-body fnt-smaller">
                                    ...
                                    <p class="hidden-xs">
                                        <?php
                                        $url    =   base_url("welcome/exhibition_details/".$exhibition->id);
