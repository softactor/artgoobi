<div class="dyna_type_of_art" id="dyna_type_of_art_Performance">
    <div class="form-group">
        ...
        <div class="col-sm-8">          
            <input type="text" class="form-control" id="site_location" placeholder="Site Or Location" name="site_location" value="<?php echo set_value('site_location'); ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">          
            <input type="text" class="form-control" id="support_elements" placeholder="Support Elements" name="support_elements" value="<?php echo set_value('support_elements'); ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">          
            <input type="text" class="form-control" id="performance_duration" placeholder="Duration" name="performance_duration" value="<?php echo set_value('performance_duration'); ?>">
