<div class="dyna_type_of_art" id="dyna_type_of_art_Print">
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="price">Edition:<span class="required"></span></label>
        <div class="col-sm-8">          
            <input type="text" class="form-control" id="tnop" placeholder="Total Number Of Prints" name="tnop" value="<?php echo set_value('tnop',$artwork_data->tnop); ?>">
            <span class='alert-danger'><?php echo form_error('tnop'); ?></span>
        </div>
    </div>
</div>