<div class="dyna_type_of_art" id="dyna_type_of_art_Video">
    <div class="form-group">
        ...
        <div class="col-sm-8">          
            <input type="text" class="form-control" id="video_format" placeholder="Please Specify" name="video_format" value="<?php echo set_value('video_format',$artwork_data->video_format); ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">          
            <input type="text" class="form-control" id="video_duration" placeholder="duration" name="video_duration" value="<?php echo set_value('video_duration',$artwork_data->video_duration); ?>">
