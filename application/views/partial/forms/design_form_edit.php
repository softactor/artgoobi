    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">          
            <select class="form-control" id="design_type" name="design_type">
                ...
                <option value="Card"<?php if(isset($artwork_data->design_type) && $artwork_data->design_type=='Card'){ echo 'selected'; } ?>>Card</option>
                <option value="Cover"<?php if(isset($artwork_data->design_type) && $artwork_data->design_type=='Cover'){ echo 'selected'; } ?>>Cover</option>
                <option value="Logo"<?php if(isset($artwork_data->design_type) && $artwork_data->design_type=='Logo'){ echo 'selected'; } ?>>Logo</option>
                <option value="Poster"<?php if(isset($artwork_data->design_type) && $artwork_data->design_type=='Poster'){ echo 'selecteds'; } ?>>Poster</option>
            </select>
