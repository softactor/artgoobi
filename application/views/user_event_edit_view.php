...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12 col-xl-12">
        <div class="row">
            ...
            <div class="col-md-9 col-lg-9 col-sm-12 col-xs-12 col-xl-9">
                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="post_category" class="form-control" id="post_category">
                                            ...
                                            foreach ($event_types as $event_type) {
                                                ?>
                                                <option value="<?php echo $event_type->id; ?>" <?php if (isset($post_data->post_category) && $post_data->post_category == $event_type->id) {
                                                echo 'selected';
...
<?php } ?>
                                    ...
                                    <div class="fetured_images_style_holder">
                                        <div class="fetured_images_style">
                                            <img class="img img-responsive" src="<?php echo base_url('images/exhibition/' . $post_data->fetured_image_path) ?>" />
                                        </div>
                                    </div>
                                    <!--</div>-->
                                    <div class="form-group">
                                        ...
                                        if (isset($post_details_data) && !empty($post_details_data)) {
                                            foreach ($post_details_data as $img_data) {
                                                ...
                                                <div class="fetured_images_style" id="related_image_id_<?php echo $img_data->id; ?>">                                        
                                                    <img class="img img-responsive" src="<?php echo base_url('images/exhibition/' . $img_data->image_path) ?>" />
