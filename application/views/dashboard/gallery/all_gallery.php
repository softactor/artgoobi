...
<!--                        <a class="btn btn-app" href="<?php echo base_url() ?>admin/exhibition/create_exhibition">
                        ...
                        <div class="box-tools pull-right">
                            <a href="<?php echo base_url() ?>admin/gallery/create_gallery" class="btn btn-flat btn-success small" title="Create gallery">
                                <i class="fa fa-plus"></i>
                            </a>
                        </div>
                        <?php } ?>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody id="users_list">
                                    ...
                                    <tr id="user_row_<?php echo $data->id; ?>">
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('admin/gallery/edit_gallery/'.$data->id) ?>"><button type="button" class="btn btn-flat btn-success small">Edit</button></a>
