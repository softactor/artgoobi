            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <!-- form start -->
                        <form id="exhibition" name="exhibition" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/gallery/process_gallery') ?>">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Gallery Title<?php echo form_error('title', '<span class="form_fields_error">', '</span>'); ?></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="start_date" name="start_date" placeholder="Enter Start Date" value="<?php echo set_value('start_date'); ?>">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">End Date<?php echo form_error('end_date', '<span class="form_fields_error">', '</span>'); ?></label>
                                    <input type="text" class="form-control" id="end_date" name="end_date" placeholder="Enter End Date" value="<?php echo set_value('end_date'); ?>">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Venue address<?php echo form_error('venue_address', '<span class="form_fields_error">', '</span>'); ?></label>
                                    <input type="text" class="form-control" id="venue_address" name="venue_address" placeholder="Enter Venue Address" value="<?php echo set_value('venue_address'); ?>">
                                </div>
                                <div class="form-group">
                                    <label>Details</label>
