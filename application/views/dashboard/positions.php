...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Positions Settings</li>
        </ol>
    </section>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="position_create();">Save changes</button>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody id="users_list">
                                    ...
                                    <tr id="user_row_<?php echo $data->id; ?>">
                                        ...
                                        <td>
                                            <a href="<?php echo base_url() ?>settings/position_edit/<?php echo $data->id; ?>">Edit</a> |
                                            <a href="#" onclick="confirm_position_delete(<?php echo $data->id; ?>);">Delete</a>
                                        </td>
                                    </tr>
                                        <?php $sl++;}}else{ ?>
                                    <tr>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="confirm_position_delete_process();">Delete</button>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
