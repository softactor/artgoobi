...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Custom Groups Settings</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a class="btn btn-app" data-toggle="modal" data-target="#custom_group_add_form">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody id="users_list">
                                    ...
                                    <tr id="user_row_<?php echo $data->id; ?>">
                                        ...
                                        <td>
                                            <a href="<?php echo base_url() ?>settings/custom_group_edit/<?php echo $data->id; ?>">Edit</a> |
                                            <a href="#" onclick="confirm_custom_group_delete(<?php echo $data->id; ?>);">Delete</a>
                                        </td>
                                    </tr>
                                        <?php $sl++;}}else{ ?>
                                    <tr>
