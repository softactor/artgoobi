                                    ...
                                    foreach ($artworks_data as $artwork) {
                                        ...
                                        <div class="col-md-4 col-lg-4 col-xs-12 col-sm-12" id="pending_artwork_operation_process_<?php echo $artwork->id; ?>">
                                            <div class="artwork_image_authentication_section">
                                                ...
                                                <div class="ineer_image_edit_delete_section">
                                                    <?php
                                                        $redirectLink   = base_url().'admin/dashboard/profile_artwork_list/'.$artwork->artist_id;
                                                        $detailsEditLink   = base_url().'admin/dashboard/profile_artwork_details/'.$artwork->artist_id.'/'.$artwork->id;
                                                    ?>
                                                    <a href="<?php echo $detailsEditLink; ?>">Details Edit</a>&nbsp;|&nbsp;
                                                    <a href="javascript:void(0)" onclick="deleteDataByIdAndTable('<?php echo $artwork->id; ?>','artwork_info', '<?php echo $redirectLink; ?>')">Delete</a>
                                                </div>
                                            </div>
                                        </div> <!-- /col -->
                                    <?php } // end of foreach ?>
