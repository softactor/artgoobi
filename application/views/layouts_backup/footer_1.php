...
$this->load->view('modal/user_login');
$this->load->view('modal/user_logout');
$this->load->view('modal/user_signin');
$this->load->view('modal/user_forget_password');
$this->load->view('modal/profile_occupation', $data);
$this->load->view('modal/profile_education', $data);
$this->load->view('modal/profile_experience', $data);
?>
<?php 
