                ...
                <div class="modal-body">
                    ...
                    <div id="signup_form_section">                        
                        ...
                        <div class="form-group">
                            ...
                            <input autocomplete="off" onkeyup="check_profile_name_availability(this.value);" type="text" id="profile_link_name_id" name="profile_link_name" class="form-control" placeholder="Enter Profile Link name">
                            <span class="help-block"></span>
