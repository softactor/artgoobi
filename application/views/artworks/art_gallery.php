...
if (isset($galleries) && !empty($galleries)) {
    ...
    <div class="front_art_work_wrapper">    
        ...
        foreach ($galleries as $artwork) {
            ...
            $artistnameData = getNameByIdAndTable($artist_table, $artist_id);
            $artistname     = $artistnameData->name;
            ...
            <div class="artwork_image_holder">
                <div class="inner">
                    ...
                    ?>
                    <a class="example-image-link" href="<?php echo base_url(); ?>uploads/artwork/<?php echo $artwork->image_original; ?>" data-lightbox="example-set" data-title="<a href='<?php echo $custom_url; ?>'><?php echo $artwork->title."<br>By ".$artistname; ?></a>">
