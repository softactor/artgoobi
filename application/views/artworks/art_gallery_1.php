...
<!--                                        <li class="front_artwork_list"><h2>Price:&nbsp;--><?php //echo $artwork->price; ?><!--</h2></li>-->
                                        <li class="front_artwork_list">
<!--                                            <a class="example-image-link" href="--><?php //echo base_url(); ?><!--uploads/artwork/--><?php //echo $artwork->image_original; ?><!--" data-lightbox="example-set" data-title="--><?php //echo $artwork->title; ?><!--">-->
<!--                                                Large View-->
<!--                                            </a>-->
<!--                                            <br>-->
<!--                                            <a href="--><?php //echo base_url('welcome/artwork_details/' . $artwork->artist_id . '/' . $artwork->id); ?><!--">Details View</a>-->
                                        </li>
                                    </ul>
